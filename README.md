...
3. [Usage - Configuration options and additional functionality](#usage)
    ...
    * [Create an access rule for pg_hba.conf](#create-an-access-rule-for-pg_hba.conf)
    * [Create user name maps for pg_ident.conf](#create-user-name-maps-for-pg_ident.conf)
